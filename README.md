...
* 아비넷테크
  ...
  * 우대사항
    ...
    * 학과전공자
    * 정보처리기사,정보처리산업기사
    * 전산학,컴퓨터공학,응용소프트웨어공학,정보,통신공학
  
* 아이엠에스모빌리티
  * 주요업무

    *  b2b플랫폼 서비스 운영및 관리 시스템 개발
    *  ims모빌리티 플랫폼서비스 인프라 아키텍처 고도화
    *  클라이언트와 프론트엔드에 필요한 api설계및 구현
  * 자격요건  
  ...
  * 우대사항
    ...
    * Flask,aws,php,lac 관련 경험이 있으신분
    * 플랫폼 개발 프로젝트를 계획하고 주도한 경험이 있으신분
    * 대기업 it스타트업에서 백엔드 개발을 경험하신분
  
* 트래포트
  * 주요업무

    *  api 기반의  시스템에서 anfgukar로 프론트 사이트를 개발합니다
    *  기존에 개발된 웹사이트를 수정하거나 추가 기능을 개발합니다
    *  향후에 개발될 솔루션의 프론트 개발업무를 담당합니다
  * 자격요건  
